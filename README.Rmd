...
- Requires R >= 4.1.0, ggplot2 >= 4.0.2, FactoMineR >= 2.13, and ggpubrplus >= 0.9.0.1.
- Dependency switched from ggpubr to ggpubrplus (>= 0.9.0.1).
...
**This fork:**
> Erdey L (2026). Supplementary compatibility updates for factoextra (Kassambara & Mundt, 2020): Modern R ecosystem support (ggplot2 ≥4.0.2, FactoMineR ≥2.13, R ≥4.1.0) — to be cited with the original package. R package version 1.2.0.1. https://doi.org/10.5281/zenodo.18131494
